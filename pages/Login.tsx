      ...
      <div className="hidden lg:flex w-1/2 bg-indigo-600 p-24 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-6xl font-black text-white leading-tight mb-8">
            The future of <br/>academic assessment <br/>starts here.
          </h2>
        ...
        <div className="relative z-10 flex items-center gap-6">
          <div className="flex -space-x-3">
             {[1,2,3,4].map(i => (
                <img key={i} className="w-12 h-12 rounded-full border-4 border-indigo-600 object-cover" src={`https://i.pravatar.cc/100?u=${i+10}`} alt="User" />
              ))}
          </div>
          <p className="text-indigo-200 font-bold text-sm">Trusted by <br/>top universities</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-24 bg-white">
        <div className="max-w-md w-full">
          <div className="mb-12">
            ...
            <p className="text-gray-500 font-medium">Login to your dashboard to manage assessments.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link to="/forgot-password" className="text-xs font-bold text-indigo-600 hover:text-indigo-700">Forgot?</Link>
              </div>
              <div className="relative group">
                <input
                  type="password"
