  ...
  const students = [
    {
      ...
      flag: "🎓",
      quote:
        "knowLearn has completely transformed how we conduct mid-terms. The AI generation saves hours of manual work while maintaining high academic standards.",
    },
    {
      name: "Sarah Jenkins",
      ...
      flag: "🏥",
      quote:
        "The confidence tracking is a game-changer. It helped me realize I was guessing on topics I thought I knew well, allowing me to focus my studies effectively.",
    },
    {
      name: "Luca Moretti",
      ...
      flag: "🏫",
      quote:
        "My students find the interface much more engaging than traditional forms. The real-time feedback loop keeps them motivated throughout the semester.",
    },
  ];
    ...
    >
      ...
      <section className="px-12 py-12 lg:py-24 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20">
        <div className="lg:w-1/2">
          <h1 className="text-5xl lg:text-7xl font-black text-gray-900 leading-[1.1] mb-10 tracking-tight">
            A <span className="text-indigo-600">unique</span> approach to
            academic excellence
          </h1>
          <p className="text-gray-400 text-lg mb-12 max-w-sm leading-relaxed font-medium">
            Build intelligent assessments, track student confidence, and unlock
            data-driven learning outcomes.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              size="lg"
              className="!rounded-2xl px-12 py-5 shadow-xl shadow-indigo-100"
              onClick={handleCta}
            >
        ...
        <div className="grid md:grid-cols-3 gap-16">
          {values.map((v, i) => (
            <div key={i} className="flex flex-col items-center group">
              <div
                className={`w-24 h-24 ${v.color} rounded-3xl flex items-center justify-center text-4xl mb-10 transition-transform group-hover:scale-110 group-hover:rotate-6 duration-500`}
              >
                {v.icon}
              </div>
      ...
      <section className="py-32 max-w-7xl mx-auto px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {frameworks.map((f, i) => (
            <div
              key={i}
              className={`p-10 rounded-[48px] border-2 ${f.accent} bg-white group hover:bg-indigo-600 transition-all duration-500 hover:border-transparent hover:-translate-y-4`}
            >
              ...
              <h4 className="text-xl font-black text-gray-900 mb-4 group-hover:text-white transition-colors">
                {f.title}
              </h4>
              <p className="text-sm font-medium text-gray-400 leading-relaxed group-hover:text-indigo-50 transition-colors">
                {f.desc}
              </p>
            </div>
          ))}
      ...
      <section className="py-32 max-w-7xl mx-auto px-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {faqs.map((faq, i) => (
            <div
              key={i}
              className={`p-10 rounded-[40px] border transition-all duration-500 cursor-pointer select-none ${
                expandedFAQ === i
                  ? "bg-indigo-600 text-white border-transparent shadow-2xl shadow-indigo-200"
              ...
              <div className="flex justify-between items-center">
                ...
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 transition-all ${
                    expandedFAQ === i
                      ? "bg-white text-indigo-600 rotate-45"
      ...
      <section className="py-40 max-w-7xl mx-auto px-12 text-center">
        <h2 className="text-5xl lg:text-6xl font-black text-gray-900 mb-6 tracking-tight">
          Try the AI builder today
        </h2>
        <p className="text-gray-400 font-bold text-lg mb-16">
          Design your first academic assessment in under 60 seconds.
        </p>
        <div className="flex max-w-xl mx-auto bg-gray-50 rounded-full p-2 pl-8 border border-gray-100 shadow-inner">
          <input
            ...
            className="bg-transparent flex-grow outline-none font-bold text-sm"
          />
          <Button
            className="!rounded-full px-12 py-5 shadow-lg"
            icon={<FiSend />}
            onClick={handleCta}
          >
            Get started
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-16">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-[11px] text-gray-400 font-bold leading-relaxed mb-10">
              2025 knowLearn. All rights reserved. <br />
              Precision academic assessments for the modern era.
            </p>
          </div>

          <div>
            <h5 className="text-[11px] font-black uppercase tracking-[0.3em] text-gray-900 mb-8">
              Company
            </h5>
          ...
          <div className="flex items-end justify-end gap-6 h-full col-span-2">
            <a
              href="#"
              className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-gray-400 hover:text-indigo-600 hover:shadow-lg transition-all"
            >
              <FiTwitter size={20} />
            </a>
            <a
